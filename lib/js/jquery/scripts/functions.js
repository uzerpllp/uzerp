	...
	$("#included_file").uz_ajax({
		...
		complete	: function() {
						...
						if (main_job_success) {
							...
							$('#dialogfinish').append('<img id="dialogsuccess" style="display:block; margin-left: auto; margin-right: auto" src="/themes/default/graphics/small_tick.png"/>');
						} else {
							$('#dialog').append('<div id="dialogfinish" class="center">'+options.fail_message+'</div>');
							$('#dialogfinish').append('<img id="dialogfail" style="display:block; margin-left: auto; margin-right: auto" src="/themes/default/graphics/small_error.png"/>');
						}
