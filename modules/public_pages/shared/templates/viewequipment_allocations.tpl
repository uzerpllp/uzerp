 ...
 **}
{* $Revision: 1.2 $ *}
{content_wrapper title=$projectequipmentallocations->title}
	{paging}
	{assign var=templatemodel value=$projectequipmentallocations->getModel()}
	{assign var=fields value=$projectequipmentallocations->getHeadings()}
	{data_table}
		{heading_row}
			...
			{/foreach}
		{/heading_row}
		{foreach name=datagrid item=model from=$projectequipmentallocations}
