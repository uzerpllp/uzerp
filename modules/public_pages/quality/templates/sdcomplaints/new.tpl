 ...
 **}
{* $Revision: 1.26 $ *}
{content_wrapper title=false}
	{form controller="sdcomplaints" action="save" class="uz-validate"}
		{with model=$models.SDComplaint legend="Complaint Details"}
			{if $action=='edit'}	
			...
			<dl id="view_data_left">
				{view_section heading="complaint_details" expand="open"}
					...
					{input type='text' attribute='order_number' } 
					{input type='text' attribute='customer' } 
				...
				{view_section heading="save_complaint" expand="open"}
					...
					{submit id='saveform' name='save' value='Save and Close' class="uz-validate"}
				{/view_section}
			</dl>
