...
class Person extends Party
{
    ...
    public function __construct($tablename = 'person')
    {
        ...
        $this->setConcatenation('fullname', ['title', 'firstname', 'middlename', 'surname', 'suffix']);
        $this->setConcatenation('titlename', ['title', 'firstname', 'surname']);
     ...
     *
     */
    public function getByCompany($_company_id = COMPANY_ID, $_current = true)
    {
    ...
    public function getCurrent($cc = null)
    {
