...
class Company extends Party
{
    ...
    protected $defaultDisplayFields = ['name', 'accountnumber', 'town', 'phone', 'email', 'website'];

    public function __construct($tablename = 'company')
    {
        ...
        $this->addValidator(new DistinctValidator(['id', 'parent_id'], 'Account cannot be it\'s own parent'));
    ...
    public function getSystemRelatedCompanies($_company_ids = [])
    {
     ...
     * @return boolean
     */
    public function isSystemCompany()
    {
