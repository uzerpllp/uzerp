...
class PartyAddress extends DataObject
{
	...
	function __construct($tablename='partyaddress')
	 {
		...
		$this->setComposite('Address', 'address_id', 'fulladdress', array('street1', 'street2', 'street3', 'town', 'county', 'postcode', 'country'));
