...
class Party extends DataObject
{
    ...
    public function __construct($tablename = 'party')
    {
        ...
        $this->setAlias('main_address', 'PartyAddress', $cc, 'main_address', ['street1', 'street2', 'street3', 'town', 'county', 'postcode', 'country'], 'party_id');

        $cc = new ConstraintChain();
        $cc->add(new Constraint('main', '=', 'true'));
        $cc->add(new Constraint('type', '=', 'T'));
        $this->setAlias('phone', 'PartyContactMethod', $cc, 'contact', [], 'party_id');

        $cc = new ConstraintChain();
        $cc->add(new Constraint('main', '=', 'true'));
        $cc->add(new Constraint('type', '=', 'M'));
        $this->setAlias('mobile', 'PartyContactMethod', $cc, 'contact', [], 'party_id');

        $cc = new ConstraintChain();
        $cc->add(new Constraint('main', '=', 'true'));
        $cc->add(new Constraint('type', '=', 'F'));
        $this->setAlias('fax', 'PartyContactMethod', $cc, 'contact', [], 'party_id');
