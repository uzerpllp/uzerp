	...
	{form controller="employeerates" action="save"}
		{with model=$models.EmployeeRate legend="Employee Rate"}
			...
			{else}
				...
				{view_data attribute='default_units' }
				{view_data attribute='units_variable'}
				{view_data attribute='rate_value' }
				{view_data attribute='rate_variable'}
				{view_data attribute='pay_frequency_id' }
