...
<dl>
	...
	<dt>{"add_new_currency_items"|prettify}</dt>
		<dd><img src="/assets/graphics/new_small.png" alt="New" />{link_to module="$module" submodule="$submodule" controller="currencys" action="new" value="add_new_currency"} &raquo;</dd>
		<dd><img src="/assets/graphics/new_small.png" alt="New" />{link_to module="$module" submodule="$submodule" controller="currencyrates" action="new" value="add_new_currency_rate"} &raquo;</dd>
