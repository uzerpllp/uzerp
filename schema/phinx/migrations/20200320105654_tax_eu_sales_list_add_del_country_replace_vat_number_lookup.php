...
class TaxEuSalesListAddDelCountryReplaceVatNumberLookup extends UzerpMigration
{
    public function up()
    {
...
SELECT si.id,
    ...
    CASE
        WHEN dpad.vatnumber is not null
        THEN dpad.vatnumber
        ELSE coy.vatnumber
    END as vat_number,
    ...
    LEFT JOIN partyaddress dpad ON dpad.id = si.del_partyaddress_id
