CREATE OR REPLACE VIEW po_structure_lines AS
 SELECT ph.due_date, ph.order_number, ph.plmaster_id, ph.receive_action, pl.id, pl.order_id, pl.line_number
...
, pl.line_discount, pl.os_qty, pl.revised_qty, pl.del_qty, pl.due_delivery_date, pl.actual_delivery_date
, pl.gr_note, pl.status, pl.usercompanyid, pl.stitem_id, pl.tax_rate_id, plm.name AS supplier
, (i.item_code::text || ' - '::text) || i.description::text AS stitem, u.uom_name
, i.item_code, st.ststructure_id
   FROM po_lines pl
