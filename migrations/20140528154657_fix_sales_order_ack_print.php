<?php
/**
 * Phinx Migration: report_definitions
 * 
 * Update the XSL for SalesOrder Acknowledgement output stored in report_definitions
 * 
...
class FixSalesOrderAckPrint extends AbstractMigration
{
