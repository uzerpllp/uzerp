...
class ReportDefinitionProFormaInvoice extends AbstractMigration
{   
    /**
     * Migrate Up.
     */
		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			...
			<fo:page-sequence master-reference="default-sequence">
				...
				<fo:static-content flow-name="xsl-region-after"  font-size="8px">
							...
							<fo:table-body>
								<xsl:for-each select="data/extra/vat_analysis/line">
									<fo:table-row>
										...
										<fo:table-cell padding="0.5mm" <!--[table_cell_borders]--> >
											<fo:block><xsl:value-of select="net_amount" /></fo:block>
										</fo:table-cell>
										<fo:table-cell padding="0.5mm" <!--[table_cell_borders]--> >
					...
					<!-- settlement table -->
					<fo:block-container absolute-position="absolute" left="0" top="1.5cm" width="10.5cm">	
						<fo:table table-layout="fixed" >
					...
					<!-- delivery table -->
					<fo:block-container absolute-position="absolute" right="0" top="2.5cm" width="9cm">	
						<fo:table table-layout="fixed" >
							<fo:table-column column-width="proportional-column-width(100)" />
							<fo:table-header>
								<fo:table-row>
