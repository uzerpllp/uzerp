...
class SiHeaderOverviewProject extends AbstractMigration
{
    /**
     * Change Method.
     *
...
VIEW;
		...
		// we need to save any dependencies for si_headeroverview
		$this->query("select deps_save_and_drop_dependencies('public', 'si_headeroverview')");
		$this->query('DROP VIEW si_headeroverview');
		$this->query($siheadersoverview);
		$this->query('ALTER TABLE si_headeroverview OWNER TO "www-data"');
		$this->query("select deps_restore_dependencies('public', 'si_headeroverview')");
